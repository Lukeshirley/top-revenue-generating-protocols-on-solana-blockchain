...
if 'result' in data:
    ...
    # Convert 'total_revenue' to string to avoid OverflowError
    df['total_revenue'] = df['total_revenue'].astype(str)
    ...
    grouped_df.to_sql('protocols', engine, if_exists='replace', index=False, dtype={'total_revenue': 'TEXT'})
